...
const Sidebar = ({ mobileOpen, onClose }) => {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-5 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-white font-bold text-base tracking-tight">StackUp AI</span>
            <p className="text-slate-500 text-xs leading-none mt-0.5">Placement Platform</p>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex flex-col w-64 bg-slate-900 border-r border-slate-800 fixed inset-y-0 left-0 z-30">
        <SidebarContent />
      </aside>
